...
describe("Sample Tests", function() {
  it("Should pass sample tests", function() {
    ...
    // test a right diagonal win
    game = new Connect4();
    assert.equal(game.play(6), "Player 1 has a turn", "Should return 'Player 1 has a turn'")
    assert.equal(game.play(5), "Player 2 has a turn", "Should return 'Player 2 has a turn'")
    assert.equal(game.play(5), "Player 1 has a turn", "Should return 'Player 1 has a turn'")
    assert.equal(game.play(4), "Player 2 has a turn", "Should return 'Player 2 has a turn'")
    assert.equal(game.play(3), "Player 1 has a turn", "Should return 'Player 1 has a turn'")
    assert.equal(game.play(4), "Player 2 has a turn", "Should return 'Player 2 has a turn'")
    ...
    // random game involving the entire board
    game = new Connect4();
    assert.equal(game.play(3), "Player 1 has a turn", "Should return 'Player 1 has a turn'")
    assert.equal(game.play(3), "Player 2 has a turn", "Should return 'Player 2 has a turn'")
    assert.equal(game.play(3), "Player 1 has a turn", "Should return 'Player 1 has a turn'")
    ...
    assert.equal(game.play(5), "Player 1 has a turn", "Should return 'Player 1 has a turn'")
    assert.equal(game.play(5), "Player 2 has a turn", "Should return 'Player 2 has a turn'")
    assert.equal(game.play(5), "Player 1 wins!", "Should return 'Player 1 wins!'")
  });
});